...
EMULATOR_SRCS  = emulator/apu.cpp emulator/cpu.cpp emulator/emulator_frontend.cpp emulator/memory.cpp emulator/opcodes.cpp emulator/ppu.cpp emulator/emulator_log.cpp

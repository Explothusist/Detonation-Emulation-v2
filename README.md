...
SDL-Drawing-Library requires SDL3 to build. Detonation Emulation v2 relies on the library's version of SDL3, but requires the .dll to run. Specifically, it needs SDL3_image.dll, SDL3_ttf.dll, and SDL3.dll. See SDL-Drawing-Library for more information.
